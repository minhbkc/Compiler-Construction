...
void compileTypeDecls(void) {
  ...
  // TypeDecls ::= epsilon
  // while TK_IDENT do TK_IDENT is the beginning of the TypeDecl
  while(lookAhead->tokenType == TK_IDENT)
  {
	  compileTypeDecl();
  }
...
void compileUnsignedConstant(void) {
  ...
  switch(lookAhead->tokenType)
  {
	  ...
	  default:
	  {
		  error(ERR_INVALIDCONSTANTTYPE, lookAhead->lineNo, lookAhead->colNo);
		  break;
	  }
  }
}
...
void compileParams(void) {
  ...
  // Params ::= epsilon
  // FIRST(Params) = SB_LPAR
  // FOLLOW(Params) = {SB_SEMICOLON, SB_COLON}
  switch(lookAhead->tokenType)
  {
	  case SB_LPAR:
	  {
...
void compileAssignSt(void) {
  ...
  // TODO
  // AssignSt ::= Variable SB_ASSIGN Expession
  // First(Variable) = {TK_IDENT}
  // First(Function identify) = {TK_IDENT}
  // violation of LL(1)
  switch(lookAhead->tokenType)
  {
	  case TK_IDENT:
...
void compileCallSt(void) {
  ...
  // TODO
  // KW_CALL ProcedureIdent Arguments
  eat(KW_CALL);
  eat(TK_IDENT);
  compileArguments();
...
void compileArguments(void) {
  // TODO
  // First(Arguments) = {SB_LPAR}
  // FOLLOW(Arguments) = {SB_ASSIGN, SB_SEMICOLON}
  switch(lookAhead->tokenType)
  {
	  case SB_LPAR:
	  {
...
void compileTerm2(void) {
  // TODO
  // BNF rule theo huong dan cua co 
  switch(lookAhead->tokenType)
  {
	  case SB_TIMES:
	  {
...
void compileFactor(void) {
  // TODO
  // line 88, 89 in BNF law with TK_IDENT --> violation LL(1)
  switch(lookAhead->tokenType)
  {
	  case TK_NUMBER:
	  {
