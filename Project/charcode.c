 ...
 * @version 1.0
 * User update: 91 CHAR_UNKNOWN -> CHAR_LSQUARE [ and 93 CHAR_UNKNOWN -> CHAR_RSQUARE ]
 */
...
CharCode charCodes[256] = {
  ...
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER,
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LSQUARE, CHAR_IVSLASH, CHAR_RSQUARE, CHAR_UNKNOWN, CHAR_UNKNOWN,
