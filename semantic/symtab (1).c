...
Object* createConstantObject(char *name) {
  ...
  strcpy(co->name, name);
  co->kind = OBJ_CONSTANT;
  co->constAttrs = (ConstantAttributes *) malloc(sizeof(ConstantAttributes));
  co->constAttrs->value = NULL;
  return co;
}

Object* createTypeObject(char *name) {
  Object* to = (Object *) malloc(sizeof(Object));
  strcpy(to->name, name);
  to->kind = OBJ_TYPE;
  to->typeAttrs = (TypeAttributes *) malloc(sizeof(TypeAttributes));
  to->typeAttrs->actualType = NULL;
  return to;
}

Object* createVariableObject(char *name) {
  Object* vo = (Object*) malloc(sizeof(Object));
  strcpy(vo->name, name);
  vo->kind = OBJ_VARIABLE;
  vo->varAttrs = (VariableAttributes*) malloc(sizeof(VariableAttributes));
  vo->varAttrs->type = NULL;
  vo->varAttrs->scope = symtab->currentScope;
  return vo;
}

Object* createFunctionObject(char *name) {
  Object* fo = (Object*) malloc(sizeof(Object));
  strcpy(fo->name, name);
  fo->kind = OBJ_FUNCTION;
  fo->funcAttrs = (FunctionAttributes*) malloc(sizeof(FunctionAttributes));
  fo->funcAttrs->paramList = NULL;
  fo->funcAttrs->returnType = NULL;
  fo->funcAttrs->scope = createScope(fo, symtab->currentScope);
  return fo;
}
...
Object* createProcedureObject(char *name) {
  ...
  strcpy(po->name, name);
  po->kind = OBJ_PROCEDURE;
  po->procAttrs = (ProcedureAttributes*) malloc(sizeof(ProcedureAttributes));
  po->procAttrs->paramList = NULL;
  po->procAttrs->scope = createScope(po, symtab->currentScope);
  return po;
}

Object* createParameterObject(char *name, enum ParamKind kind, Object* owner) {
  Object* pao = (Object*) malloc(sizeof(Object));
  strcpy(pao->name, name);
  pao->kind = OBJ_PARAMETER;
  pao->paramAttrs = (ParameterAttributes*) malloc(sizeof(ParameterAttributes));
  pao->paramAttrs->function = owner;
  pao->paramAttrs->kind = kind;
  pao->paramAttrs->type = NULL; // FIXME
  return pao;
}
